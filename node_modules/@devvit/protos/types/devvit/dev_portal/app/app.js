...
import { appPromoStatusFromJSON, appPromoStatusToJSON } from "../../../reddit/devvit/ads/v1/ads.js";
...
import { computeClusterFromJSON, computeClusterToJSON } from "./info/compute_cluster.js";
export var OrderBy;
(function (OrderBy) {
...
export const AppSearchRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            categoryIds: globalThis.Array.isArray(object?.categoryIds)
                ? object.categoryIds.map((e) => globalThis.Number(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.categoryIds?.length) {
            obj.categoryIds = message.categoryIds.map((e) => Math.round(e));
        }
        if (message.ownerId !== undefined) {
...
function createBaseGetAllWithOwnerRequest() {
    return { owner: "", take: undefined, skip: undefined };
}
...
function createBaseMediaSignature() {
    return { filePath: "", size: 0, hash: "", isWebviewAsset: false, mimeType: undefined };
}
...
function createBaseAppUpdateRequest() {
    return {
        ...
        minSubredditSizeRestrictionEnabled: undefined,
        promoStatus: undefined,
        categoryIds: [],
        isArchived: undefined,
        defaultComputeCluster: undefined,
        isTrusted: undefined,
    };
}
export const AppUpdateRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.minSubredditSizeRestrictionEnabled !== undefined) {
            writer.uint32(104).bool(message.minSubredditSizeRestrictionEnabled);
        }
        if (message.promoStatus !== undefined) {
            writer.uint32(112).int32(message.promoStatus);
        }
        ...
        if (message.isArchived !== undefined) {
            BoolValue.encode({ value: message.isArchived }, writer.uint32(130).fork()).ldelim();
        }
        if (message.defaultComputeCluster !== undefined) {
            writer.uint32(136).int32(message.defaultComputeCluster);
        }
        if (message.isTrusted !== undefined) {
            writer.uint32(144).bool(message.isTrusted);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    message.minSubredditSizeRestrictionEnabled = reader.bool();
                    continue;
                case 14:
                    if (tag !== 112) {
                        break;
                ...
                case 16:
                    ...
                    message.isArchived = BoolValue.decode(reader, reader.uint32()).value;
                    continue;
                case 17:
                    if (tag !== 136) {
                        break;
                    }
                    message.defaultComputeCluster = reader.int32();
                    continue;
                case 18:
                    if (tag !== 144) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            minSubredditSizeRestrictionEnabled: isSet(object.minSubredditSizeRestrictionEnabled)
                ? globalThis.Boolean(object.minSubredditSizeRestrictionEnabled)
                : undefined,
            promoStatus: isSet(object.promoStatus) ? appPromoStatusFromJSON(object.promoStatus) : undefined,
            categoryIds: globalThis.Array.isArray(object?.categoryIds)
                ? object.categoryIds.map((e) => globalThis.Number(e))
                : [],
            isArchived: isSet(object.isArchived) ? Boolean(object.isArchived) : undefined,
            defaultComputeCluster: isSet(object.defaultComputeCluster)
                ? computeClusterFromJSON(object.defaultComputeCluster)
                : undefined,
            isTrusted: isSet(object.isTrusted) ? globalThis.Boolean(object.isTrusted) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.minSubredditSizeRestrictionEnabled !== undefined) {
            obj.minSubredditSizeRestrictionEnabled = message.minSubredditSizeRestrictionEnabled;
        }
        if (message.promoStatus !== undefined) {
        ...
        if (message.defaultComputeCluster !== undefined) {
            obj.defaultComputeCluster = computeClusterToJSON(message.defaultComputeCluster);
        }
        if (message.isTrusted !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.minSubredditSizeRestrictionEnabled = object.minSubredditSizeRestrictionEnabled ?? undefined;
        message.promoStatus = object.promoStatus ?? undefined;
        message.categoryIds = object.categoryIds?.map((e) => e) || [];
        message.isArchived = object.isArchived ?? undefined;
        message.defaultComputeCluster = object.defaultComputeCluster ?? undefined;
        message.isTrusted = object.isTrusted ?? undefined;
        return message;
    },
};
messageTypeRegistry.set(AppUpdateRequest.$type, AppUpdateRequest);
function createBaseFullAppInfo() {
    return { app: undefined, versions: [], fetchDomainRequests: [] };
}
export const FullAppInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.fetchDomainRequests) {
            FetchDomainRequestInfo.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
function createBaseAppWithDomainInfo() {
    return { appId: "", appSlug: "", appName: "", appOwnerAccount: undefined, domainRequests: [], allowedDomains: [] };
}
export const AppWithDomainInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.appOwnerAccount !== undefined) {
            Redditor.encode(message.appOwnerAccount, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.domainRequests) {
            FetchDomainRequestInfo.encode(v, writer.uint32(42).fork()).ldelim();
        }
        for (const v of message.allowedDomains) {
            FetchDomain.encode(v, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseAppWithDomainInfo();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                ...
                case 5:
                    ...
                    message.domainRequests.push(FetchDomainRequestInfo.decode(reader, reader.uint32()));
                    continue;
                case 6:
                    if (tag !== 50) {
                        break;
                    }
                    message.allowedDomains.push(FetchDomain.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            domainRequests: globalThis.Array.isArray(object?.domainRequests)
                ? object.domainRequests.map((e) => FetchDomainRequestInfo.fromJSON(e))
                : [],
            allowedDomains: globalThis.Array.isArray(object?.allowedDomains)
                ? object.allowedDomains.map((e) => FetchDomain.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.domainRequests?.length) {
            obj.domainRequests = message.domainRequests.map((e) => FetchDomainRequestInfo.toJSON(e));
        }
        if (message.allowedDomains?.length) {
            obj.allowedDomains = message.allowedDomains.map((e) => FetchDomain.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return AppWithDomainInfo.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAppWithDomainInfo();
        ...
        message.appOwnerAccount = (object.appOwnerAccount !== undefined && object.appOwnerAccount !== null)
            ...
            : undefined;
        message.domainRequests = object.domainRequests?.map((e) => FetchDomainRequestInfo.fromPartial(e)) || [];
        message.allowedDomains = object.allowedDomains?.map((e) => FetchDomain.fromPartial(e)) || [];
        return message;
    },
};
messageTypeRegistry.set(AppWithDomainInfo.$type, AppWithDomainInfo);
function createBaseGetAppBySlugWithDomainInfoRequest() {
    return { appSlug: "" };
}
export const GetAppBySlugWithDomainInfoRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseGetAppBySlugWithDomainInfoRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return { appSlug: isSet(object.appSlug) ? globalThis.String(object.appSlug) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.appSlug !== "") {
    ...
    create(base) {
        return GetAppBySlugWithDomainInfoRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetAppBySlugWithDomainInfoRequest();
        message.appSlug = object.appSlug ?? "";
...
messageTypeRegistry.set(GetAppBySlugWithDomainInfoRequest.$type, GetAppBySlugWithDomainInfoRequest);
function createBaseGetAppsWithDomainInfoRequest() {
    return { pageSize: 0, pageNumber: 0 };
}
export const GetAppsWithDomainInfoRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseGetAppsWithDomainInfoRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return GetAppsWithDomainInfoRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetAppsWithDomainInfoRequest();
...
messageTypeRegistry.set(GetAppsWithDomainInfoRequest.$type, GetAppsWithDomainInfoRequest);
function createBaseGetAppsWithDomainInfoResponse() {
    return { apps: [], hasNextPage: undefined };
}
export const GetAppsWithDomainInfoResponse = {
    $type: "devvit.dev_portal.app.GetAppsWithDomainInfoResponse",
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.apps) {
            AppWithDomainInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseGetAppsWithDomainInfoResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.apps.push(AppWithDomainInfo.decode(reader, reader.uint32()));
                    continue;
                case 2:
                    if (tag !== 16) {
                        break;
    ...
    fromJSON(object) {
        return {
            apps: globalThis.Array.isArray(object?.apps) ? object.apps.map((e) => AppWithDomainInfo.fromJSON(e)) : [],
    ...
    toJSON(message) {
        ...
        if (message.apps?.length) {
            obj.apps = message.apps.map((e) => AppWithDomainInfo.toJSON(e));
        }
        if (message.hasNextPage !== undefined) {
    ...
    create(base) {
        return GetAppsWithDomainInfoResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetAppsWithDomainInfoResponse();
        message.apps = object.apps?.map((e) => AppWithDomainInfo.fromPartial(e)) || [];
        message.hasNextPage = object.hasNextPage ?? undefined;
        return message;
    },
};
messageTypeRegistry.set(GetAppsWithDomainInfoResponse.$type, GetAppsWithDomainInfoResponse);
function createBaseAddDomainsToAppRequest() {
    return { appId: "", domains: [] };
}
export const AddDomainsToAppRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseAddDomainsToAppRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return AddDomainsToAppRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAddDomainsToAppRequest();
        message.appId = object.appId ?? "";
...
messageTypeRegistry.set(AddDomainsToAppRequest.$type, AddDomainsToAppRequest);
function createBaseRemoveDomainFromAppRequest() {
    return { appId: "", domain: "" };
}
export const RemoveDomainFromAppRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseRemoveDomainFromAppRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return RemoveDomainFromAppRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRemoveDomainFromAppRequest();
        message.appId = object.appId ?? "";
...
messageTypeRegistry.set(RemoveDomainFromAppRequest.$type, RemoveDomainFromAppRequest);
function createBaseMediaSignatureStatus() {
    return { filePath: "", isNew: false, existingMediaId: undefined, uploadUrl: undefined, uploadHeaders: {} };
}
export const MediaSignatureStatus = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.uploadHeaders).forEach(([key, value]) => {
            MediaSignatureStatus_UploadHeadersEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    const entry5 = MediaSignatureStatus_UploadHeadersEntry.decode(reader, reader.uint32());
                    if (entry5.value !== undefined) {
                        message.uploadHeaders[entry5.key] = entry5.value;
                    }
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            uploadHeaders: isObject(object.uploadHeaders)
                ? Object.entries(object.uploadHeaders).reduce((acc, [key, value]) => {
    ...
    toJSON(message) {
        ...
        if (message.uploadHeaders) {
            const entries = Object.entries(message.uploadHeaders);
            if (entries.length > 0) {
                obj.uploadHeaders = {};
                entries.forEach(([k, v]) => {
                    obj.uploadHeaders[k] = v;
                });
            }
        }
        return obj;
    ...
    fromPartial(object) {
        ...
        message.uploadHeaders = Object.entries(object.uploadHeaders ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
function createBaseMediaSignatureStatus_UploadHeadersEntry() {
    return { key: "", value: "" };
}
export const MediaSignatureStatus_UploadHeadersEntry = {
    $type: "devvit.dev_portal.app.MediaSignatureStatus.UploadHeadersEntry",
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseMediaSignatureStatus_UploadHeadersEntry();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return MediaSignatureStatus_UploadHeadersEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMediaSignatureStatus_UploadHeadersEntry();
...
messageTypeRegistry.set(MediaSignatureStatus_UploadHeadersEntry.$type, MediaSignatureStatus_UploadHeadersEntry);
