...
import { ComputeCluster } from "./info/compute_cluster.js";
...
export interface AppUpdateRequest {
    ...
    defaultComputeCluster?: ComputeCluster | undefined;
...
export interface MediaSignatureStatus_UploadHeadersEntry {
    key: string;
    value: string;
}
...
export declare const MediaSignatureStatus_UploadHeadersEntry: {
    $type: "devvit.dev_portal.app.MediaSignatureStatus.UploadHeadersEntry";
    encode(message: MediaSignatureStatus_UploadHeadersEntry, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MediaSignatureStatus_UploadHeadersEntry;
    fromJSON(object: any): MediaSignatureStatus_UploadHeadersEntry;
    toJSON(message: MediaSignatureStatus_UploadHeadersEntry): unknown;
    create(base?: DeepPartial<MediaSignatureStatus_UploadHeadersEntry>): MediaSignatureStatus_UploadHeadersEntry;
    fromPartial(object: DeepPartial<MediaSignatureStatus_UploadHeadersEntry>): MediaSignatureStatus_UploadHeadersEntry;
};
